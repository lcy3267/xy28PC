...
export default {
  ...
  lottery: {
    ...
    addSpecialGameRule: 'POST /gameRules/admin/addSpecialGameRule',
    updateSpecialGameRule: 'PUT /gameRules/admin/updateSpecialGameRule',
    specialGameRules: 'GET /gameRules/admin/specialGameRules',
  },
  system: {
